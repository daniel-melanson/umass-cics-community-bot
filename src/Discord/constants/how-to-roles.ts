...
export const ROLES_TUTORIAL = formatEmbed({
	...
	fields: [
		...
		},
		{
			...
			value: oneLine(`Direct message an administrator with either 
			a discord invite to your clubs server or a person of reference.
			The person of reference should be another club officer.`),
		},
	],
});
